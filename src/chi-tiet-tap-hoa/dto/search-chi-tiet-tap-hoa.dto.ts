...
export class SearchChiTietTapHoaDto {
  ...
  @ApiPropertyOptional({ description: 'Trường sắp xếp', default: 'maChiTietHoaDon' })
  @IsOptional()
  @IsIn(['maChiTietHoaDon', 'soLuong'])
  sortBy?: string = 'maChiTietHoaDon';
